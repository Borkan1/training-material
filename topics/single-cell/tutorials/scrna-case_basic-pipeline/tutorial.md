...
> > 2. You can see in the {% icon tool %} **General information about the object** output that the matrix is `31627 x 35734`. This is `obs x vars`, or rather, `cells x genes`, so there are `31627 cells` and `35734 genes` in the matrix.
> >
> {: .solution}
>
{: .question}
